...
export PATH=:$HOME/.rvm/bin:~:/usr/local/git/bin:~/projects/topo/commands:/usr/bin:/bin:/usr/sbin:/sbin:/usr/local/bin:/usr/X11/bin:$HOME/.bin:$HOME/.rvm/bin:/opt/local/bin:/opt/local/sbin:$PATH
